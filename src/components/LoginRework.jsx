...
function LoginRework() {
    ...
    return <div className="w-screen h-screen bg-background-secondary flex justify-center items-center"> {/* bg-gradient-to-b from-blue-400 to-blue-600*/}
        ...
        <div className="w-screen sm:w-[70%] h-[80%] shadow-lg bg-background-primary flex sm:block flex-col justify-center">

            <div className="w-[38%] hidden sm:block h-full float-left bg-cover bg-no-repeat bg-center">
            ...
            <div className="w-screen sm:w-[60%] h-[30%] float-right px-8 sm:px-4 pt-6 flex flex-col justify-center">
                <div tabIndex="0" className="my-2 flex justify-center items-center border-2 border-gray-400 h-[2.5rem] rounded-md bg-none font-semibold cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-color-secondary ring-offset-background-primary">
                    ...
                    <p className="ml-2 py-2 text-font-color text-md">Continue with Google</p>
                </div>
                <div tabIndex="0" className="my-2 flex justify-center items-center border-2 border-gray-400 h-[2.5rem] rounded-md bg-none font-semibold cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-color-secondary ring-offset-background-primary">
                    ...
                    <p className="ml-2 py-2 text-font-color text-md">Continue with Facebook</p>
                </div>
                <div tabIndex="0" className="my-2 flex justify-center items-center border-2 border-gray-400 h-[2.5rem] rounded-md bg-none font-semibold cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-color-secondary ring-offset-background-primary">
                    ...
                    <p className="ml-2  py-2 text-font-color text-md">Continue with Apple</p>
                </div>

            </div>

            <div className="flex justify-center items-center h-[10%] w-full sm:w-[50%] px-8">
                <div className="w-[45%] h-[1px] bg-font-color float-left"></div>
                <div className="w-[10%] text-font-color flex justify-center items-center">Or</div>
                <div className="w-[45%] h-[1px] bg-font-color float-right"></div>
            </div >
            <form onSubmit={(e) => SignIn(e)} className="w-screen sm:w-[60%] h-fit px-8 sm:px-4 py-4 float-right flex flex-col justify-center">

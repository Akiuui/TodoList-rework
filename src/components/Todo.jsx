...
function Todo() {
    ...
    console.log(user)
    let firstCharOfUser = user.displayName.toUpperCase().charAt(0);
    ...
    return <div name="screen" className="w-screen h-screen bg-gray-200 flex justify-center items-center">
        ...
        <div name="top-banner" className="w-screen h-[2.8125rem] py-1 bg-white absolute top-0
         flex justify-between" >
            ...
            <div className="flex">
                ...
                <div onClick={() => userDropDown.current.classList.toggle('invisible')} className="rounded-full text-xl text-blue-500 border-[.1875rem] mr-4  w-[2.375rem] h-[2.375rem]       
                 flex justify-center items-center cursor-pointer duration-500 hover:border-gray-300 ">{user && firstCharOfUser}</div>  {/*Circle with initialz*/}

                {/*Dropdown window for account*/}

                <div ref={userDropDown} className="absolute border-2 right-[25px] top-[50px] bg-white px-2 py-2 shadow-md z-50 invisible">
        ...
        <div className="bg-white w-[60%] h-[70%] px-[2.1875rem] py-[2.1875rem] drop-shadow-2xl" name="body">
            ...
            <div name='scroll' className="h-[85%] border-y-2 border-gray-300 overflow-x-hidden overflow-scroll">
                ...
                {/*Print todo-function*/}
                <PrintTodo isDelete={isDelete} setIsDelete={setIsDelete} todo={todo} setTodo={setTodo} plus={plus} />
                {/*Print todo-function*/}
